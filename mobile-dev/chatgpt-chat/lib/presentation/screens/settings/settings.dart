        ...
        children: [
          BlocBuilder<OpenAIKeyCubit, OpenAIKeyState>(
            builder: (context, state) {
              return ListTile(
                title: const Text("Ajouter Open Ai API Key"),
                subtitle: Text(state is OpenAIKeyLoadedState
                    ? "${state.key.substring(1, 10)}*****"
                    : ""),
                    ...
                    builder: (context) {
                      return AlertDialog(
                        ...
                        content: TextFormField(
                          autofocus: true,
                          decoration:
                              const InputDecoration(hintText: "OpenAI API Key"),
                          onChanged: (value) {
                            key = value;
                          },
                        ),
